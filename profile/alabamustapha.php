		...
		<div class="content">
			...
			<div id="contact-box">
				...
				<form class="contact-form">
					...
					<input class="form-input" type="email" name="email" placeholder="email i can reply to" required>
					<input class="form-input" type="text" name="subject" placeholder="Why are you sending this mail" required>
					<textarea class="form-input" name="body" placeholder="message content" rows="25"></textarea>
					<button type="submit" class="form-input"><i class="fa fa-send"></i> Send</button>
				</form>
			</div>
