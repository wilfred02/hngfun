...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <img src="./zee_img.JPG" class="" style="width:100%" alt="Owner's Profile Photo">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small">I'm</span> Gafar Azeez.</h1>
    <p>Web Developer.</p>
    <img src="./zee_img.JPG" alt="" class="image" width="327" height="488" alt="Profile Photo">
  </header>
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    ...
    <h3 class="w3-padding-16 w3-text-light-grey">Slack Username</h3>
    <bold><p class="">@Zee</p></bold>
    <br>
    ...
    <a href="https://github.com/ZeeUnltd/php_test">
      ...
      <h3 class="w3-padding-24 w3-text-light-grey">Click for Stage 1 Repository </h3>
    </a>
  ...
  <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
    ...
    <div class="w3-section">
      ...
      <p><i class="fa fa-phone fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Phone: 08030470290</p>
      <p><i class="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"> </i> Email: azegaf@mail.com</p>
  ...
  <footer class="w3-content w3-padding-64 w3-text-grey w3-xlarge">
    ...
    <p class="w3-medium"><a href="#" target="_blank" class="w3-hover-text-green">HNG-Intern</a></p>
  <!-- End footer -->
  </footer>
