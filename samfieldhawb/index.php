...
<body>
	...
	<div>
		...
		<section class="about">
			<h2>About Me</h2>
			<p>My name is Samfield Hawb Bassey, am a native of Mbiatok Itam in Itu <abbr title="Local Goverment Area">L.G.A</abbr> of Akwa Ibom State of the Federal
			Republic of Nigeria, a National Diploma holder of Civil Engineering from Federal Polytechnic, Nekede,Owerri,imo state.</p>
			<p>I have been working with computers for a couple of years even before my polytechnic education. Some years ago became interested in talking to the computer to behave the way i want, which made me started programming,i never attended a computer school, but i was a regular customer to the cybeCafe.</p>
			...
			<p>I am a big fan of IT that is why I train myself on some of programming languages, looking forward into artificial intelligent (AI) </p>
			<div class="progress">
