...
<div class="p-card">
    <div class="v-center">
        <div class="p-card-photo" style="background-image: url(https://infinityfree.net/accounts/epiz_20600668/files?action=download&path=%2Fhtdocs%2Fprofile.JPG); background-size: cover; background-repeat: no-repeat; background-position: center center; "></div>
        <div class="p-card-info">
