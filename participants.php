		    ...
		    <div class="p-card">
                    ...
                    <!--  Each Participants ends here  -->
                        ...
                        <!-- Each Participant starts here -->
                            ...
                            <div class="p-card">
                                <div class="v-center">
                                    <div class="p-card-photo" style="background-image: url(http://imgur.com/a/Q8we4); background-size: cover; background-repeat: no-repeat; background-position: center center; "></div>
                                    <div class="p-card-info">
                                        <a href="http://hng.fun/profile/markowitz/index.html">
                                            <!--Profile Link-->
