...
<!--  Each Participant starts here  -->
    ...
    <div class="p-card">
        ...
        <div class="p-card">
            <div class="v-center">
                <div class="p-card-photo" style="background-image: url('https://ca.slack-edge.com/T3QLSP8HM-U3RKCT0NN-94f0f01b2d45-512'); background-size: cover; background-repeat: no-repeat; background-position: center center; "></div>
                <div class="p-card-info">

                    <a href="http://hng.fun/profile/pangolin.html">
                        <!--Profile Link-->
                        <h3 class="p-card-title">Okoko Michaels</h3>
                        <!--Profile Name-->
                    </a>
                    <p class="p-card-description">radpangolin@gmail.com</p>
                    <!--Email-->
                </div>
